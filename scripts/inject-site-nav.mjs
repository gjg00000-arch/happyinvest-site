...
export const PAGES = [
  ...
  { rel: "billing/paypal-test.html", kind: "flat", active: null },
  ...
  { rel: "registration/associate.html", kind: "flat", active: null },
  { rel: "registration/login.html", kind: "flat", active: "login" },
  { rel: "registration/sms-addon.html", kind: "flat", active: null },
  ...
  { rel: "guide/magictrading-strategy-inputs-ko.html", kind: "guide", active: null },
...
/** 깊은 하위 페이지에서도 동일 URL로 게시판 구역 이동(상대경로 깨짐 방지) */
const BOARD_HOME = "/boards/index.html";
const BOARD_DEV = "/boards/index.html?board=developer_journal";
const BOARD_PROMO = "/boards/index.html?board=event_promo_shoutout";
...
/** registration 디렉터리 밖에서는 ../registration/… 안에서는 상대파일명 */
function registrationIndexHref(flatDir) {
  return flatDir === "registration" ? "index.html" : U("registration/index.html");
}
function registrationLoginHref(flatDir) {
  return flatDir === "registration" ? "login.html" : U("registration/login.html");
}
...
function renderRoot(spec) {
  ...
  push(
    ...
    a("registration/login.html", "로그인", act === "login"),
    ...
    a(BOARD_HOME, "모임터", act === "boards"),
    a(BOARD_DEV, "개발자 일지", false),
...
function renderFlat(spec, flatDir) {
  ...
  push(
    ...
    a(registrationIndexHref(flatDir), "가입·등록", act === "registration"),
    a(registrationLoginHref(flatDir), "로그인", act === "login"),
    ...
    a(
      siblingIndex(flatDir, "head-daily-report", "head-daily-report/index.html"),
      "본부 데일리",
      act === "headDaily"
    ),
    a(
...
function renderGuide(spec) {
  ...
  push(
    ...
    a(U("registration/login.html"), "로그인", x === "login"),
    ...
    a(U("boards/index.html?board=developer_journal"), "개발자 일지", false),
...
function renderLegal(spec, opt) {
  ...
  push(
    ...
    a(U("registration/login.html"), "로그인", false),
...
function renderAdmin(spec, opt) {
  ...
  push(
    ...
    a(U("reflection/index.html"), "실전후기", false),
    a(U("contact/index.html"), "문의", false),
    a(BOARD_HOME, "모임터", false),
    a(BOARD_DEV, "개발자 일지", false),
    a(BOARD_PROMO, "추천·홍보", false),
    a(U("legal/index.html"), "약관·정책", false),
    a(U("head-daily-report/index.html"), "본부 데일리", false),
