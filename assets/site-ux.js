  ...
  var I18N = {
    ...
    en: {
      ...
      homeI18nFoldHtml: [
        ...
        "The operations team reviews TRV usernames, MT5 identifiers, and email in the internal ledger before follow-up.",
        "</p>",
        "</section>",
    ...
    ja: {
      ...
      homeI18nFoldHtml: [
        ...
        "</ol>",
        '<p class="small" style="margin: 1rem 0 0; max-width: min(70rem, 100%); line-height: 1.62; color: var(--ci-brown-muted)">',
        "運営チームは内部台帳でTRVユーザー名・MT5識別子・メールを確認し、後続対応を進めます。",
        "</p>",
        "</section>",
        '<section class="ml-cloud-care" aria-labelledby="ml-cloud-care-title">',
    ...
    zh: {
      ...
      homeI18nFoldHtml: [
        ...
        "</ol>",
        '<p class="small" style="margin: 1rem 0 0; max-width: min(70rem, 100%); line-height: 1.62; color: var(--ci-brown-muted)">',
        "运营团队会在内部台账中核对 TRV 用户名、MT5 标识和邮箱后继续处理。",
        "</p>",
        "</section>",
        '<section class="ml-cloud-care" aria-labelledby="ml-cloud-care-title">',
